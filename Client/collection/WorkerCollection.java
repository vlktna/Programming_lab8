...
public class WorkerCollection {
    ...
    public ObservableList<WorkerProperty> createObservableList(){
        ObservableList<WorkerProperty> workers = FXCollections.observableArrayList();
        getCollectionFromDB();

        for(int i = 0; i < this.workers.size(); i++){
            WorkerProperty workerProperty = new WorkerProperty(this.workers.get(i));
            workers.add(workerProperty);
        }
